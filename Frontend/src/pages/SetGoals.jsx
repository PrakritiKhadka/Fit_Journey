...
const SetGoals = () => {
  ...
  const validateForm = () => {
    ...
    if (
      isNaN(parseFloat(newGoal.currentValue)) ||
      parseFloat(newGoal.currentValue) < 0
    ) {
      setLocalError("Current value must be a positive number");
      return false;
    }
    if (
      isNaN(parseFloat(newGoal.targetValue)) ||
    ...
    <div className="container">
      ...
      {(error || localError) && (
        <div className="error-banner">
          {error || localError}
          <button onClick={() => setLocalError(null)} className="close-error">
            ×
          </button>
        </div>
      )}
      ...
      <div className="goal-section">
        ...
        {goals.length === 0 ? (
          <div className="no-goals">
            You haven't set any goals yet. Create one above to get started!
          </div>
        ) : (
              ...
              return (
                <div className="goal-card" key={goal._id}>
                  ...
                  <div className="goal-values">
                    {goal.initialValue &&
                      goal.initialValue !== goal.currentValue && (
