  ...
  const userVlogs = [
    {
      ...
      views: "15.2K",
      story:
        "When I started with Fit Journey, I was skeptical about another fitness platform. But the personalized tracking helped me see patterns I never noticed before. Six months later, I'm down 30 pounds and have more energy than ever.",
    },
    {
      id: 2,
      name: "Mike T.",
      ...
      views: "8.7K",
      story:
        "Training for my first marathon seemed impossible until I started using Fit Journey to track my runs. The website helped me gradually increase mileage while monitoring recovery. Crossed the finish line last month and already planning my next race!",
    },
    {
      id: 3,
      name: "Aisha J.",
      ...
      views: "12.3K",
      story:
        "As someone who had never run before, the Couch to 5K program on Fit Journey was a game-changer. The progress tracking kept me motivated even on tough days. Three months later, I completed my first 5K and I'm now training for a 10K.",
    },
  ];
    ...
    <div className="about-us-container">
      ...
      <section className="intro-section">
        <div className="intro-content">
          <h2>Our Mission</h2>
          <p>
            At Fit Journey, we believe fitness tracking should be motivational,
            not complicated. we've built a powerful yet intuitive platform that
            you to be motivated and work hard for your physical health everyday.
          </p>
          <p>Your success is our story and your health is our priority .</p>
        </div>
      </section>
      ...
      <section className="workout-section">
        ...
        <p>
          Discover fitness routines designed to help you reach your goals
          efficiently.
        </p>
              ...
              <div key={workout._id} className="workout-cards ">
                ...
                <p className="workout-description">
                  {workout.notes?.substring(0, 60) ||
                    "A comprehensive workout designed to help you achieve your fitness goals."}
      ...
      <section className="vlogs-section">
        ...
        <p className="vlogs-section-description">
          Real progress tracked and shared by our community members.
        </p>
      ...
      <section className="join-section">
        ...
        <p>
          Join thousands of members who are visualizing their progress and
