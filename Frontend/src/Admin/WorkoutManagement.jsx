          ...
          <div className="stat-card small">
            ...
            <div className="stat-value">
              {activeTab === "admin"
                ...
                : summaryStats.userWorkouts.totalDurationCompleted}{" "}
              min
            </div>
          </div>
        </div>
        ...
        <div className="workouts-section">
          ...
          <div className="table-container">
            <table className="data-table">
              ...
              <tbody>
                {(activeTab === "admin" ? adminWorkouts : userWorkouts).map(
                  (workout) => (
                    <tr key={workout._id}>
                      <td>{workout.name}</td>
                      ...
                      <td>
                        {workout.lastUsed
                          ? formatDate(workout.lastUsed)
                          : "Never"}
                      </td>
                      <td>
                        {workout.createdBy?.name ||
                          workout.createdBy?.email ||
                          "N/A"}
                      </td>
                ...
                <div className="detail-section">
                  ...
                  <div className="detail-grid">
                    ...
                    <div className="detail-item">
                      ...
                      <span className="detail-value">
                        {selectedWorkout.caloriesBurn} cal
                      </span>
                    </div>
                  </div>
                </div>
                    ...
                    {selectedWorkout.reminderEnabled &&
                      selectedWorkout.reminderTime && (
                        <div className="detail-item">
                          <Bell size={16} />
                          <span className="detail-value">
                            Reminder: {selectedWorkout.reminderTime} minutes
                            before workout
                          </span>
                        </div>
                      )}
